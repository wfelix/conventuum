...
export default function Agenda() {
    const { listDataDoctors, listDoctors, signOut } = useApp();
    const [
    ...
    console.log('skdjsk', listDataDoctors)
    ...
    return (
        <>
            ...
            <div className="max-w-2xl mx-auto p-6 text-black">
                ...
                <div className="mt-8">
                    <h2 className="text-xl font-bold mb-4">Lista de médicos</h2>
                    <div className="space-y-4">


                        {listDataDoctors.map((doctors: any) => (
                            ...
                            <div key={doctors.id} className="bg-white p-4 rounded-lg shadow flex flex-raw justify-between items-center">
                                <div>
                                    ...
                                    <div className='flex gap-2 items-center mb-4'>
                                        <label>  {`Especialidade: ${doctors.specialty}`}</label>
